...
export default function AppLayout() {
  ...
  // 👇 Abrir/cerrar submenú según la ruta actual
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh", bgcolor: "background.default" }}>
      ...
      >
        ...
        <List>
          {primaryLinks.map((l) => (
            <ListItemButton key={l.to} component={NavLink} to={l.to} selected={pathname.startsWith(l.to)}>
          ...
          {/* ===== Configuración ===== */}
          <ListItemButton onClick={() => setOpenConfig((o) => !o)} selected={pathname.startsWith("/configuracion")}>
